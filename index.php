...
<div class="standard-box">
    <div>
        ...
        <div class="content-box">
            <div>
                <img src="/ToKaFitness/includes/Images/man_giving_advice.jpg" alt="Man discussing fitness results 
        ...
        <div class="content-box">
            ...
            <div>
                <img src="/ToKaFitness/includes/Images/man_reading.jpg" alt="Man in living room reading from a tablet"
                style="width:35rem;height:22.5rem">
            </div>
        </div>
        <!-- creates the third content box with the image on the left and the text on the right-->
        <div class="content-box">
            <div>
                <img src="/ToKaFitness/includes/Images/man_working_at_laptop.jpg" alt="Man at a table working on a laptop"
                style="width:35rem;height:22.5rem">
            </div>
            <div>
